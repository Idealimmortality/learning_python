...
def intoSaoyiSao(driver):
  ...
  el8.click()
  e12 = WebDriverWait(driver,timeout=5,poll_frequency=0.01).until(lambda x: x.find_element_by_id("com.alipay.mobile.scan:id/title_bar_album"))
  e12.click()
  time.sleep(2)
...
""" Photo = ["照片13，2020年10月21日 14点23分 ","照片14，2020年10月21日 14点23分 ","照片15，2020年10月21日 14点23分 ",\
...
""" Photo = ["照片1，2020年10月21日 14点23分 ","照片2，2020年10月21日 14点23分 ","照片3，2020年10月21日 14点23分 ","照片4，2020年10月21日 14点23分 ","照片5，2020年10月21日 14点23分 ",\
...
def inputPassword(driver):
  driver.tap([(179,1657)],1)
  driver.tap([(179,1657)],1)
  driver.tap([(179,1347)],1)
  driver.tap([(533,1823)],1)
  driver.tap([(179,1347)],1)
  driver.tap([(892,1509)],1)
  # time.sleep(5)
  WebDriverWait(driver,timeout=5,poll_frequency=0.01).until(lambda x: x.tap([(979,149)],5))
  # driver.tap([(979,149)],5)#完成
  # time.sleep(2)
  WebDriverWait(driver,timeout=5,poll_frequency=0.01).until(lambda x: x.tap([(179,140)],5))
  # driver.tap([(179,140)],5) #退出
  time.sleep(2)
  ...
  for i in Photo:
    ...
    while count <= 6:
      ...
      try:
        ...
        # time.sleep(5)
        el5 = WebDriverWait(driver,timeout=8,poll_frequency=0.01).until(lambda x: x.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/com.uc.webview.export.WebView/com.uc.webkit.ax/android.webkit.WebView/android.view.View/android.view.View[1]/android.view.View/android.view.View[3]/android.view.View[1]/android.view.View[1]"))
